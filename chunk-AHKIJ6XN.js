import{a as g,b as m,c as r,d as c,e as d,f as a}from"./chunk-M2JQ6YZK.js";import"./chunk-OERSU4S2.js";var w=Object.defineProperty,f=Object.getOwnPropertyDescriptor,l=(o,i,p,s)=>{for(var e=s>1?void 0:s?f(i,p):i,h=o.length-1,n;h>=0;h--)(n=o[h])&&(e=(s?n(i,p,e):n(e))||e);return s&&e&&w(i,p,e),e},t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return m`<svg
  ...
  `;l([a({type:String,reflect:!0})],t.prototype,"size",2);l([a({type:String,reflect:!0})],t.prototype,"weight",2);l([a({type:String,reflect:!0})],t.prototype,"color",2);l([a({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=l([d("ph-arrow-down")],t);export{t as PhArrowDown};
