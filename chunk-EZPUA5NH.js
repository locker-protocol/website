import{a as x}from"./chunk-BW4HDSEO.js";import{a as l,b as v,c as f}from"./chunk-BIOKOBW3.js";import{B as p,D as d,H as b,I as P,L as h,v as e}from"./chunk-7YXRK5ID.js";import{P as C,T as u}from"./chunk-G4N3XFUX.js";var A=d`
  :host {
    display: block;
  }
...
`;var $=function(t,i,r,o){var n=arguments.length,a=n<3?i:o===null?o=Object.getOwnPropertyDescriptor(i,r):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,r,o);else for(var w=t.length-1;w>=0;w--)(s=t[w])&&(a=(n<3?s(a):n>3?s(i,r,a):s(i,r))||a);return n>3&&a&&Object.defineProperty(i,r,a),a},g=class extends p{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=u.state.view}firstUpdated(){this.status=x.hasFooter()?"show":"hide",this.unsubscribe.push(u.subscribeKey("view",i=>{this.view=i,this.status=x.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(i=>{for(let r of i)if(r.target===this.getWrapper()){let o=`${r.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",o)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
...
`;var R=function(t,i,r,o){var n=arguments.length,a=n<3?i:o===null?o=Object.getOwnPropertyDescriptor(i,r):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,r,o);else for(var w=t.length-1;w>=0;w--)(s=t[w])&&(a=(n<3?s(a):n>3?s(i,r,a):s(i,r))||a);return n>3&&a&&Object.defineProperty(i,r,a),a},k=4,S=class extends p{constructor(){super(...arguments),this.walletImages=[]}render(){let i=this.walletImages.length<k;return e`${this.walletImages.slice(0,k).map(({src:r,walletName:o})=>e`
          <wui-wallet-image
            size="sm"
            imageSrc=${r}
            name=${f(o)}
          ></wui-wallet-image>
        `)}
    ${i?[...Array(k-this.walletImages.length)].map(()=>e` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};S.styles=[b,E];R([l({type:Array})],S.prototype,"walletImages",void 0);S=R([h("wui-all-wallets-image")],S);var O=d`
  :host {
    width: 100%;
  }
...
`;var m=function(t,i,r,o){var n=arguments.length,a=n<3?i:o===null?o=Object.getOwnPropertyDescriptor(i,r):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,r,o);else for(var w=t.length-1;w>=0;w--)(s=t[w])&&(a=(n<3?s(a):n>3?s(i,r,a):s(i,r))||a);return n>3&&a&&Object.defineProperty(i,r,a),a},z={eip155:"ethereum",solana:"solana",bip122:"bitcoin",polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:"ton",tron:"tron"},c=class extends p{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return this.dataset.size=this.size,e`
      <button
    ...
    `}templateNamespaces(){return this.namespaces?.length?e`<wui-flex alignItems="center" gap="0">
        ${this.namespaces.map((i,r)=>e`<wui-flex
              alignItems="center"
        ...
        name=${this.name}
      ></wui-wallet-image>`:!this.showAllWallets&&!this.imageSrc?e`<wui-wallet-image size="sm" name=${this.name}></wui-wallet-image>`:null}templateStatus(){return this.loading?e`<wui-loading-spinner size="lg" color="accent-primary"></wui-loading-spinner>`:this.tagLabel&&this.tagVariant?e`<wui-tag size="sm" variant=${this.tagVariant}>${this.tagLabel}</wui-tag>`:null}};c.styles=[b,P,O];m([l({type:Array})],c.prototype,"walletImages",void 0);m([l()],c.prototype,"imageSrc",void 0);m([l()],c.prototype,"name",void 0);m([l()],c.prototype,"size",void 0);m([l()],c.prototype,"tagLabel",void 0);m([l()],c.prototype,"tagVariant",void 0);m([l()],c.prototype,"walletIcon",void 0);m([l()],c.prototype,"tabIdx",void 0);m([l({type:Array})],c.prototype,"namespaces",void 0);m([l({type:Boolean})],c.prototype,"disabled",void 0);m([l({type:Boolean})],c.prototype,"showAllWallets",void 0);m([l({type:Boolean})],c.prototype,"loading",void 0);m([l({type:String})],c.prototype,"loadingSpinnerColor",void 0);c=m([h("wui-list-wallet")],c);export{g as a,y as b};
